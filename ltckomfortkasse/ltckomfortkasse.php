...
class LtcKomfortkasse extends Module
{
    ...
    public function displayForm()
    {
        ...
        array ('type' => 'radio','label' => $this->l('Display order numbers'),'desc' => $this->l('How to display order numbers in Komfortkasse'),'name' => Komfortkasse_Config::ordernumbers,'required' => true,'values' => array (array ('id' => 'number','value' => 'number','label' => $this->l('Number (characters, e.g. ABCDEFGH)')
        ),array ('id' => 'id','value' => 'id','label' => $this->l('ID (numeric, e.g. 00001234)')
        )
        )
        ),array ('type' => 'radio','label' => $this->l('Export orders'),'desc' => $this->l('Activate export of orders to Komfortkasse'),'name' => Komfortkasse_Config::activate_export,'required' => true,'is_bool' => true,'values' => array (array ('id' => 'active_on','value' => 1,'label' => $this->l('Enabled')
    ...
    public function install()
    {
        ...
        if (!parent::install() ||
                ...
                !Configuration::updateValue(Komfortkasse_Config::ordernumbers, 'number') ||
