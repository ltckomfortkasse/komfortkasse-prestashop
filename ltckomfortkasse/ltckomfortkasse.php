...
class LtcKomfortkasse extends Module
{
    ...
    public function displayForm()
    {
        ...
        $fields_form[0]['form'] = array(
            ...
            'input' => array(
                array(
                    'type' => 'radio',
                    'label' => $this->l('Display order numbers'),
                    'desc' => $this->l('How to display order numbers in Komfortkasse'),
                    'name' => Komfortkasse_Config::ordernumbers,
                    'required' => true,
                    'values' => array(
                        array(
                            'id' => 'number',
                            'value' => 'number',
                            'label' => $this->l('Number (characters, e.g. ABCDEFGH)')
                        ),
                        array(
                            'id' => 'id',
                            'value' => 'id',
                            'label' => $this->l('ID (numeric, e.g. 00001234)')
                        )
                    )
                ),
                array(
                    ...
                    'desc' => $this->l('Activate export of orders to Komfortkasse'),
                    'name' => Komfortkasse_Config::activate_export,
                    'required' => true,
                    'is_bool' => true,
                    'values' => array(
                        array(
                ...
                array(
                    ...
                    'desc' => $this->l('Activate update of order status (paid/cancelled)'),
                    'name' => Komfortkasse_Config::activate_update,
                    'required' => true,
                    'is_bool' => true,
                    'values' => array(
                        array(
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Prepayment: relevant payment methods'),
                    'desc' => $this->l('All payment methods that should be exported for prepayment orders.'),
                    'name' => Komfortkasse_Config::payment_methods . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $payment_method_array,
                        'id' => 'id_option',
                        'name' => 'name'
                    )
                ),
                array(
                    'type' => 'select',
                    'label' => $this->l('Prepayment: States open'),
                    'desc' => $this->l('Order states that should be exported (open orders)'),
                    'name' => Komfortkasse_Config::status_open . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                        'name' => 'name'
                    )
                ),
                array(
                    'type' => 'select',
                    'label' => $this->l('Prepayment: State paid'),
                    'desc' => $this->l('Order state that should be set when prepayment has been received'),
                    'name' => Komfortkasse_Config::status_paid,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Prepayment: State cancelled'),
                    'desc' => $this->l('Order state that should be set when a prepayment order has been cancelled'),
                    'name' => Komfortkasse_Config::status_cancelled,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Invoice: relevant payment methods'),
                    'desc' => $this->l('All payment methods that should be exported for invoice orders.'),
                    'name' => Komfortkasse_Config::payment_methods_invoice . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $payment_method_array,
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Invoice: States open'),
                    'desc' => $this->l('Order states that should be exported (shipped orders)'),
                    'name' => Komfortkasse_Config::status_open_invoice . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Invoice: State paid'),
                    'desc' => $this->l('Order state that should be set when an invoice has been paid'),
                    'name' => Komfortkasse_Config::status_paid_invoice,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('Invoice: State no payment/debt collection'),
                    'desc' => $this->l('Order state that should be set when an invoice was not paid'),
                    'name' => Komfortkasse_Config::status_cancelled_invoice,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('COD: relevant payment methods'),
                    'desc' => $this->l('All payment methods that should be exported for COD (cash on delivery) orders.'),
                    'name' => Komfortkasse_Config::payment_methods_cod . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $payment_method_array,
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('COD: States open'),
                    'desc' => $this->l('Order states that should be exported (dispatched COD parcel)'),
                    'name' => Komfortkasse_Config::status_open_cod . '[]',
                    'multiple' => true,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('COD: State paid'),
                    'desc' => $this->l('Order state that should be set when a COD order has been paid'),
                    'name' => Komfortkasse_Config::status_paid_cod,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    'type' => 'select',
                    'label' => $this->l('COD: State payment unresolved'),
                    'desc' => $this->l('Order state that should be set when a COD order was not paid'),
                    'name' => Komfortkasse_Config::status_cancelled_cod,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $order_status_array,
                        'id' => 'id_option',
                ...
                array(
                    ...
                    'desc' => $this->l('Encryption technology. Do not change! Is set automatically by komfortkasse'),
                    'name' => Komfortkasse_Config::encryption,
                    'class' => 'fixed-width-xxl',
                    'options' => array(
                        'query' => $encryption_array,
                        'id' => 'id_option',
                        'name' => 'name'
                    )
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Access code (encrypted)'),
                    'desc' => $this->l('Encrypted access code. Do not change! Is set automatically by komfortkasse'),
                    'name' => Komfortkasse_Config::accesscode,
                    'class' => 'fixed-width-xxl'
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('API Key'),
                    'desc' => $this->l('Key for accessing the API. Do not change! Is set automatically by komfortkasse'),
                    'name' => Komfortkasse_Config::apikey,
                    'class' => 'fixed-width-xxl'
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Public key'),
                    'desc' => $this->l('Key for encrypting data that is sent to komfortkasse. Do not change! Is set automatically by komfortkasse'),
                    'name' => Komfortkasse_Config::publickey,
                    'class' => 'fixed-width-xxl'
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Private key'),
                    'desc' => $this->l('Key for decrypting data that is received from komfortkasse. Do not change! Is set automatically by komfortkasse'),
                    'name' => Komfortkasse_Config::privatekey,
                    'class' => 'fixed-width-xxl'
                )
            ),
            'submit' => array(
        ...
        // Load current value
        $helper->fields_value[Komfortkasse_Config::ordernumbers] = Komfortkasse_Config::getConfig(Komfortkasse_Config::ordernumbers);
    ...
    public function install()
    {
        ...
        if (! parent::install() || ! $this->registerHook('actionOrderStatusPostUpdate') || ! Configuration::updateValue(Komfortkasse_Config::ordernumbers, 'number') || ! Configuration::updateValue(Komfortkasse_Config::activate_export, true) || ! Configuration::updateValue(Komfortkasse_Config::activate_update, true) || ! Configuration::updateValue(Komfortkasse_Config::payment_methods, 'bankwire') || ! Configuration::updateValue(Komfortkasse_Config::status_open, '10') || ! Configuration::updateValue(Komfortkasse_Config::status_paid, '2') || ! Configuration::updateValue(Komfortkasse_Config::status_cancelled, '6') || ! Configuration::updateValue(Komfortkasse_Config::payment_methods_invoice, '') || ! Configuration::updateValue(Komfortkasse_Config::status_open_invoice, '4') || ! Configuration::updateValue(Komfortkasse_Config::status_paid_invoice, '') || ! Configuration::updateValue(Komfortkasse_Config::status_cancelled_invoice, '') || ! Configuration::updateValue(Komfortkasse_Config::payment_methods_cod, '') || ! Configuration::updateValue(Komfortkasse_Config::status_open_cod, '4') || ! Configuration::updateValue(Komfortkasse_Config::status_paid_cod, '') || ! Configuration::updateValue(Komfortkasse_Config::status_cancelled_cod, '') || ! Configuration::updateValue(Komfortkasse_Config::encryption, '') || ! Configuration::updateValue(Komfortkasse_Config::accesscode, '') || ! Configuration::updateValue(Komfortkasse_Config::apikey, '') || ! Configuration::updateValue(Komfortkasse_Config::publickey, '') || ! Configuration::updateValue(Komfortkasse_Config::privatekey, '')) {
            return false;
        } else {
            return true;
        }
